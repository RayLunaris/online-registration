...
## Corpus Check
- 118 files · ~196,651 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 667 nodes · 1516 edges · 40 communities (35 shown, 5 thin omitted)
...
5. `StudentCompleteDetail` - 21 edges
...
- `MajorTabsProps` --references--> `Major`  [EXTRACTED]
  src/components/public/leaderboard/MajorTabs.tsx → src/types/spmb.ts
- `AdminLayout()` --calls--> `useSchool()`  [EXTRACTED]
  src/components/admin/AdminLayout.tsx → src/context/SchoolContext.tsx
...
- `Footer()` --calls--> `useLanguage()`  [EXTRACTED]
  src/components/common/Footer.tsx → src/context/LanguageContext.tsx
...
Cohesion: 0.14
Nodes (33): AdminSecretLoginModalProps, StatusResultCard(), AnnouncementsSectionProps, Alert, AlertDescription, AlertTitle, alertVariants, Badge() (+25 more)

### Community 1 - "App.tsx"
Cohesion: 0.09
Nodes (17): AdminAnnouncementsPage, AdminDashboardPage, AdminMajorsPage, AdminSelectionPage, AdminSettingsPage, AdminSourceSchoolsPage, AdminStudentsPage, AnnouncementDetailPage (+9 more)

### Community 2 - "cn"
Cohesion: 0.06
Nodes (42): AdminStudentDetailPage, RankingSection(), MajorTabs(), MajorTabsProps, CardFooter, DialogFooter(), DropdownMenu(), DropdownMenuItem() (+34 more)

### Community 3 - "HomePage.tsx"
Cohesion: 0.12
Nodes (25): FAQSection(), AboutSection(), AboutSectionProps, AdmissionRequirementsSection(), AdmissionScheduleSection(), AnnouncementsSection(), FeatureBand(), HIGHLIGHTS_EN (+17 more)
...
### Community 9 - "Major"
Cohesion: 0.09
Nodes (36): SelectionPanel(), MajorChoicesTab(), Props, Props, StudentTable(), Props, MajorsSectionProps, LeaderboardTable() (+28 more)

### Community 10 - "RegistrationPage.tsx"
Cohesion: 0.07
Nodes (39): RegistrationCardPage, Props, Props, RegistrationSuccessCard(), clearDraft(), DraftPayload, readDraft(), SaveDraftOptions (+31 more)

### Community 11 - "spmb.ts"
Cohesion: 0.07
Nodes (48): AuthContext, AuthContextType, AuthProvider(), RegistrationStatusResult, AsyncLock, mockStoreLock, computeRegistrationStatus(), fetchRegistrationStatus() (+40 more)

### Community 12 - "ThemeContext.tsx"
Cohesion: 0.40
Nodes (4): Theme, ThemeContext, ThemeContextType, ThemeProvider()
...
Cohesion: 0.24
Nodes (11): Footer(), Navbar(), PublicLayout(), SchoolContext, SchoolProvider(), useSchool(), useTheme(), LoginPage() (+3 more)
...
### Community 39 - "AdminLayout.tsx"
Cohesion: 0.48
Nodes (4): AdminLayout(), AdminSecretLoginModal(), ProtectedRoute(), useAuth()
...
- **Why does `cn()` connect `cn` to `button.tsx`, `Major`?**
...
- **Why does `Major` connect `Major` to `button.tsx`, `cn`, `HomePage.tsx`, `RegistrationPage.tsx`, `spmb.ts`, `Footer.tsx`?**
