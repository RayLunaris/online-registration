# Graph Report - Pendaftaran  (2026-09-12)

## Corpus Check
- 114 files · ~190,616 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 652 nodes · 1458 edges · 35 communities (31 shown, 4 thin omitted)
...
7. `isSupabaseConfigured()` - 19 edges
8. `formatDate()` - 19 edges
9. `formatScore()` - 18 edges
10. `compilerOptions` - 18 edges

## Surprising Connections (you probably didn't know these)
- `DraftPayload` --references--> `RegistrationFormData`  [EXTRACTED]
  src/hooks/useFormDraft.ts → src/types/spmb.ts
...
- `AboutSectionProps` --references--> `School`  [EXTRACTED]
  src/components/home/AboutSection.tsx → src/types/spmb.ts
...
Cohesion: 0.13
Nodes (39): SelectionPanel(), MajorChoicesTab(), StudentTable(), StatusResultCard(), AlertDescription, Badge(), BadgeProps, badgeVariants (+31 more)

### Community 1 - "App.tsx"
Cohesion: 0.05
Nodes (37): AdminAnnouncementsPage, AdminDashboardPage, AdminMajorsPage, AdminSelectionPage, AdminSettingsPage, AdminSourceSchoolsPage, AdminStudentDetailPage, AdminStudentsPage (+29 more)

### Community 2 - "cn"
Cohesion: 0.08
Nodes (36): CardFooter, DropdownMenu(), DropdownMenuItem(), DropdownMenuProps, FormDescription(), FormItem(), FormLabel(), FormMessage() (+28 more)

### Community 3 - "HomePage.tsx"
Cohesion: 0.11
Nodes (25): FAQSection(), Navbar(), PublicLayout(), AboutSection(), AdmissionRequirementsSection(), AdmissionScheduleSection(), AnnouncementsSection(), AnnouncementsSectionProps (+17 more)
...
### Community 9 - "public/LeaderboardPage.tsx"
Cohesion: 0.21
Nodes (11): LeaderboardPage, LeaderboardTable(), LeaderboardTableProps, SearchMyRank(), SearchMyRankProps, SearchResultInfo, Alert, AlertTitle (+3 more)

### Community 10 - "RegistrationPage.tsx"
Cohesion: 0.07
Nodes (36): AdminSecretLoginModalProps, DialogDescription(), DialogFooter(), DialogHeader(), DialogProps, DialogTitle(), ADMIN_AUTH_CONFIG, UseAdminShortcutOptions (+28 more)

### Community 11 - "spmb.ts"
Cohesion: 0.05
Nodes (67): Props, Props, Props, AboutSectionProps, HeroSectionProps, MajorsSectionProps, RankingSection(), MajorTabs() (+59 more)
...
- **Why does `cn()` connect `cn` to `button.tsx`, `public/LeaderboardPage.tsx`, `RegistrationPage.tsx`, `spmb.ts`?**
...
- **Why does `Button` connect `button.tsx` to `App.tsx`, `cn`, `HomePage.tsx`, `public/LeaderboardPage.tsx`, `RegistrationPage.tsx`, `spmb.ts`?**
