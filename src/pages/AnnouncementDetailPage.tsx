    ...
    return (
      <div className="min-h-screen bg-slate-50 py-16">
        <div className="container mx-auto px-4 text-center max-w-md space-y-4">
          ...
          <h2 className="text-xl font-bold text-slate-900">Pengumuman Tidak Ditemukan</h2>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <article className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-12">
          ...
          {announcement.thumbnail_url && (
            <div className="h-64 sm:h-96 w-full overflow-hidden bg-slate-100 relative">
              <img
          ...
          <div className="p-6 sm:p-10">
              ...
              >
                {copied ? (
                  <>
                    ...
                    <span className="text-emerald-600 font-semibold">Tautan Disalin!</span>
                  </>
                ) : (
                  <>
            ...
            {/* Title */}
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 tracking-tight mt-6 leading-snug">
              {announcement.title}
            </h1>

            {/* Article Content */}
            <div className="mt-8 text-slate-700 leading-relaxed text-sm sm:text-base space-y-4 whitespace-pre-line">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {relatedAnnouncements.map((item) => (
                <Card
                  key={item.id}
                  className="overflow-hidden border-slate-200 hover:shadow-md transition-shadow bg-white flex flex-col justify-between"
                >
                  <CardHeader className="p-4">
                    ...
                    <CardDescription className="text-xs text-slate-600 line-clamp-2 mt-1.5">
                      {item.content}
                    </CardDescription>
                  </CardHeader>
                </Card>
